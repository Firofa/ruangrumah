    ...
    <div className="home">
      ...
      <section className="hero">
        <div className="announce">
          ...
          <p>Introducing RuangRumah</p>
        </div>

        <h1>Design Your Dream Space with AI-Powered Interior Design</h1>

        <p className="subtitle">
          Upload a photo of your room and let AI generate stunning design ideas
